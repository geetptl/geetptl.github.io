        ...
        <section className='bg-slate-800 min-h-screen text-slate-100'>
          ...
          <MobileView>
            <div className='text-center px-6 py-10'>
              <h2 className='text-xl text-slate-200'>A developer, a student,</h2>
              <h2 className='text-slate-400 py-3'>a &#40;self-recognised&#41; mathematician, a home cook, an amatuer tennis player, and a lot more...</h2>
            </div>
